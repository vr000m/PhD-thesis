...
adoption of high quality real-time communication. To deliver high quality
video not only corresponds to an increase in required network capacity, but
also assurance of network stability. A real-time multimedia application that
uses the Real-time Transport Protocol (RTP) over UDP needs to implement
congestion control since UDP does not implement any congestion control. This
...
We propose a sender-driven, a receiver-driven and an hybrid congestion control
