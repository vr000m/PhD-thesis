...
experiments discussed in the paper. He also acted as the main editor of the
paper.}
...
\addcontribution{The author of this dissertation was one of the co-authors of
the paper~\cite{Singh:FECRC}. His contribution consisted of providing the main
idea for the paper, implementing the comparative algorithms, providing the
configurations for the experiments and co-editing the paper.}
