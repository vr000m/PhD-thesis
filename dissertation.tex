...
\addpublication[submitted]{V. Singh, S. McQuistin, M. Ellis, C.
...
discussed in the paper. He also acted as the main editor of the paper.}

% Add the errata of the publication, remove if there are none. (in submitted
% paper this is unlikely)
%\adderrata{This is wrong}
% Add the publication pdf file, the filename is the parameter.
%\addpublicationpdf{add/}

\addpublication[submitted]{V. Singh, A. A. Lozano, J. Ott}{Performance
...
\addcontribution{The author of this dissertation was the main author of this
paper~\cite{Singh:rrtcc.eval}. His contribution consisted of implementing the
algorithms and conducting experiments in one of the two evaluation scenarios
discussed in the paper. He also acted as the main editor of the paper.}
