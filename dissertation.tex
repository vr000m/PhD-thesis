...
%
Colin Perkins, his book on RTP is a practioners guide -- covers aspects of the
...
Markus, J\'{o}se-Luis, Pavan and Tatu for the help and support during
...
paper and co-edited the paper with Colin Perkins. He equally contributed to 
the ideas and concepts discussed in the paper and he also contributed to
implementing the algorithm and the overall system, conducting experiments for
the interactive video scenario and analysing the results.}
