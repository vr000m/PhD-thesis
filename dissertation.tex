...
\addpublication[submitted]{V. Singh, S. McQuistin, M. Ellis, C. Perkins}{Circuit Breakers for Multimedia Congestion Control}{IEEE Packet Video}{San Jose, USA}{Dec}{2013}{IEEE}{c:cb}
% Add the dissertation author's contribution to that publication.
\addcontribution{The author of this dissertation was the main author of this paper~\cite{Singh:CB.eval}. 
His contribution consisted of implementing the algorithms and conducting experiments
in one of the two evaluation scenarios discussed in the paper. He also acted as the main editor of the paper.}
...
\addpublication[submitted]{V. Singh, A. A. Lozano, J. Ott}{Performance Analysis of Receive-Side Real-Time Congestion Control for WebRTC}{IEEE Packet Video}{San Jose, USA}{Dec}{2013}{IEEE}{c:eval}
% Add the dissertation author's contribution to that publication.
\addcontribution{The author of this dissertation was the main author of this paper~\cite{Singh:rrtcc.eval}. 
His contribution consisted of implementing the algorithms and conducting experiments
in one of the two evaluation scenarios discussed in the paper. He also acted as the main editor of the paper.}
...
% Add the dissertation author's contribution to that publication.
\addcontribution{The author of this dissertation was one of the co-authors of the paper~\cite{Singh:FECRC}. His
