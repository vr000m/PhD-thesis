...
discuss the performance in various application, network and flow settings.
In~\cite{draft.rmcat.evaluate} we consider the following guidelines for
evaluating congestion control.



The guidelines lead to identifying building blocks  discussed in more detail
in Section~\ref{fw.cc.eval}.
