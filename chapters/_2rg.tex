...
to cause congestion. \citepub{c:err} discusses about error resilience for
...
In \citepub{c:fecrc}, we unify the concepts of error-resilience and congestion
...
applications (e.g., Skype, Google Hangouts). \citepub{c:eval} evaluates the
