...
traffic on a bottleneck link.
 ...
 \fxnote{{\color{red} TODO: why or put these terminologies in context of the thesis?}}
...
\item Avoid congestion collapse.

\item If the channel conditions are relatively stable over time, the media
rate should be stable too because changing the media encoding rate too often
or by too much may adversely affect the users' quality of
experience~\cite{Zink03subjectiveimpression}.

\item Test performance in a range of network characteristics. Namely, varying
end-to-end capacity, latency, and router queue-sizes. Also test bottleneck
capacity sharing with varying amount of cross-traffic.

\item Feedback overhead.
...
\fxnote{{\color{red} TODO: complete this list.}}
