...
(PDV)~\cite{rfc6798}, summary statistics~\cite{draft.xr.stat}, delay
metric~\cite{rfc6843}, burst-gap discard/loss~\cite{rfc6958,
draft.xr.bg.discard}, Run-Length Encoded (RLE)
