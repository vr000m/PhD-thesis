...
the feedback rate to $5\%$ of the session \textit{media rate}, shared equally
by each participant in a video conference. Formally, the RTCP reporting
...
the next scheduled RTCP report. Hence, the slow control loop can cause
...
An endpoint can send RTCP feedback as a \emph{compound}, or \emph{minimal}
