...
Unequal Loss Protection (ULP) for both congestion control and error-
resilience. Firstly, they estimate the available rate using a variant of TFRC,
...
average goodput is also a bit lower in this case.
