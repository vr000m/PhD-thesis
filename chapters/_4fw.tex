...
$3^{rd}$\emph{--party} or a superpeer in an overlay network. Consequently, these
observed cues need to be signaled back to the sender which will perform
congestion control. We classify these congestion cues by, where are they
measured/observed, and how is the sender notified; the classifications
visualized in Figure~\ref{fig:4:fw}.
