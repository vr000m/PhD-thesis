...
It is useful to decompose an RTP application into primitive components to
discuss the operation of various congestion control functions.
...
\setlength{\itemsep}{0pt}
\item[(1)] codec type,
\item[(2)] expected frame rate,
\item[(3)] signal source device,
\item[(4)] expected display resolution.
\end{enumerate}
