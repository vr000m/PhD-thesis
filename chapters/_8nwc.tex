...
perform no congestion control and the stream are received at a constant bit
rate. For periods when the link capacity falls below the media rate, will
cause an increase in losses/discards, which may cause frequent pausing of the
video. 3) \emph{Rate-switching}, the endpoints perform short
