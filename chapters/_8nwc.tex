...
out-of-band signalling, but use in-path and off-path sources, respectively. First,
...
for signalling. Second, the off-path source is a crowd-sourced 3G coverage
