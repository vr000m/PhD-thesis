...
This thesis is about enabling congestion control for unicast real-time communication and
...
are involved the congestion control at a every source needs a strategy to adapt 
the transmission rate for each receiver or a sub-group of receivers.
...
our contributions, which is documented in~\cite{draft.adaptive.fec}, 
